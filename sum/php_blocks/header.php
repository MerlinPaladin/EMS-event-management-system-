...
<header>
    ...
    <div class="logo_and_name">
        <a href="index.php"><img class="main_image" src="images/logo.png" width="100" height="100" alt="error"></a>
        <div class="main_name">
...
<!-- черта под шапкой -->
<hr>
<!-- таблица с мероприями и последующим выбором даты для отображения событий на выбранное число -->