...
<content>
    <div class="js-sup-modal-wrapper">
        <form action="">
            <div class="l_x">
                <label style="color: #fff; font-size: x-large;">Обратная связь</label>
                <button class="exit_1">X</button>
            </div>
            <hr style="color: #fff; width: 100%; height: 3px;">
            <br>
    ...
    <div class="registration_modal_form">
        ...
        <form action="">
            ...
            <button class="register_btn">Регистрация</button>
            <p style="font-size:larger; color:#fff;">Уже есть аккаунт?<button class="login_btn">Войти</button></p>
        </form>
    </div>
