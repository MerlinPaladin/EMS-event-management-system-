...
<div class="content">
    ...
    <div class="registration_modal_form">
        <form action="">
            ...
            <p style="font-size:larger; color:#fff; display: flex; align-items: center; justify-content: space-between;">Уже есть аккаунт?<button class="login_btn">Войти</button></p>
        </form>
    </div>
