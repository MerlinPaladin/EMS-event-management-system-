...
<div class="content">
    <div class="js-sup-modal-wrapper">
        <form action="">
            <div class="l_x">
                <label class="l_x_label" style="color: #fff; margin-left: 10px;">Обратная связь</label>
    ...
    <div class="registration_modal_form">
        <form action="registration.php" method="post">
            ...
            <input class="f1_i" type="text" name="login" required placeholder="имя"><br>

            <label class="label">Email</label>
            <input class="f2_i" type="email" name="email" required placeholder="почта"><br>

            <label class="label">Пароль</label>
            <input class="f3_i" type="password" name="passwd" required placeholder="пароль"><br>
            <button id="register_btn">Регистрация</button>
            <p class="regis_p" style="color:#fff; display: flex; align-items: center; justify-content: center;">Уже есть аккаунт?<button class="login_btn">Войти</button></p>
        </form>
    </div>
    ...
    <div class="login_form">
        <form action="" method="post">
            ...
            <label class="lg_lb" for="input">Email</label>
            <input type="text" required placeholder="почта">
            <label class="lg_lb" for="input">Пароль</label>
            <input type="text" required placeholder="пароль">
            <button id="log_in">Войти</button>
            <p class="lg_p" style="  display: flex; align-items: center; justify-content: center;">Нет профиля?<button id="regis_form_show_up">Зарегистрируйтесь</button></p>
        </form>
    </div>
