document.addEventListener("DOMContentLoaded", function () {
  ...
  regis_bt.addEventListener("click", () => {
    if (regis_modal_form.style.display === "block") {
      regis_modal_form.style.display = "none";
    } else {
      closeAllModals();
      regis_modal_form.style.display = "block";
    }
  });
